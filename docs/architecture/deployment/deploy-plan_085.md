...
2. **[`sitemap.xml`](/public_html/sitemap.xml)**
...
3. **[`/.well-known/security.txt`](/public_html/.well-known/security.txt)** *(e fallback [`/security.txt`](/public_html/security.txt))*
...
4. **[`llms.txt`](/public_html/llms.txt)** & **[`llms-full.txt`](/public_html/llms-full.txt)**
...
* **[`humans.txt`](/public_html/humans.txt)**: Créditos padronizados da equipe de desenvolvimento (Josias Sobrinho, Gabriel Calidônio, Wallace Miranda), referências à FATEC e stack tecnológica (PHP 8.2, Slim 4, Twig, GoF).
* **[`manifest.webmanifest`](/public_html/manifest.webmanifest)**: Manifesto PWA (*Progressive Web App*) para suporte a instalação mobile em celulares (ícones, cor de tema e nome da aplicação).
