...
O objetivo desta tarefa é criar uma estrutura didática e funcional de artefatos **Spec-Driven Development (SDD)** no diretório [`docs/specs/`](file:///var/www/html/agsonhos/docs/specs/), servindo de modelo acadêmico/profissional de especificações de API e DTOs legíveis por humanos e Agentes de Inteligência Artificial.

## Proposed Changes

### Especificações e Schemas

#### [NEW] [README.md](file:///var/www/html/agsonhos/docs/specs/README.md)
...
#### [NEW] [openapi.yaml](file:///var/www/html/agsonhos/docs/specs/openapi.yaml)
...
#### [NEW] [OrderDataDTO.json](file:///var/www/html/agsonhos/docs/specs/schemas/OrderDataDTO.json)
...
#### [NEW] [checkout_idempotency.feature](file:///var/www/html/agsonhos/docs/specs/features/checkout_idempotency.feature)
...
Concluímos a criação dos exemplos didáticos e funcionais do padrão **Spec-Driven Development (SDD)** no diretório [`docs/specs/`](file:///var/www/html/agsonhos/docs/specs/).

## Artefatos Criados

### 1. Guia Didático e Conceitual
- **[docs/specs/README.md](file:///var/www/html/agsonhos/docs/specs/README.md)**:
...
- **[docs/specs/openapi.yaml](file:///var/www/html/agsonhos/docs/specs/openapi.yaml)**:
...
- **[docs/specs/schemas/OrderDataDTO.json](file:///var/www/html/agsonhos/docs/specs/schemas/OrderDataDTO.json)**:
...
- **[docs/specs/features/checkout_idempotency.feature](file:///var/www/html/agsonhos/docs/specs/features/checkout_idempotency.feature)**:
