...
| **Rastreabilidade** | **RF:** [RF001](/docs/requirements/functional/functional_requirements.yaml) (Fotos HD), [RF002](/docs/requirements/functional/functional_requirements.yaml) (Especificações técnicas), [RF012](/docs/requirements/functional/functional_requirements.yaml) (PDP dedicada)<br>**RN:** [RN001](/docs/requirements/business_rules/business_rules.yaml) (Variações de unidades), [RN002](/docs/requirements/business_rules/business_rules.yaml) (Peso e dimensões), [RN003](/docs/requirements/business_rules/business_rules.yaml) (Info técnica obrigatória)<br>**RNF:** [RNF001](/docs/requirements/non_functional/non_functional_requirements.yaml) (Ergonomia visual), [RNF002](/docs/requirements/non_functional/non_functional_requirements.yaml) (Velocidade) |
