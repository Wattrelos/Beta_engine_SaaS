...
| **Rastreabilidade** | **RF:** [RF004](/docs/requirements/functional/functional_requirements.yaml) (Venda de múltiplas unidades), [RF009](/docs/requirements/functional/functional_requirements.yaml) (Carrinho de compras), [RF018](/docs/requirements/functional/functional_requirements.yaml) (Checkout)<br>**RN:** [RN001](/docs/requirements/business_rules/business_rules.yaml) (Unidades fracionadas), [RN005](/docs/requirements/business_rules/business_rules.yaml) (Estoque), [RN015](/docs/requirements/business_rules/business_rules.yaml) (Preços negociados do BoQ)<br>**RNF:** [RNF001](/docs/requirements/non_functional/non_functional_requirements.yaml) (Agilidade de transição BoQ -> Checkout) |
