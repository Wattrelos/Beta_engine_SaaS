...
| **Rastreabilidade** | **RF:** [RF020](file:///var/www/html/agsonhos/docs/requirements/functional/functional_requirements.yaml) (NF-e de entrada de devolução), [RF023](file:///var/www/html/agsonhos/docs/requirements/functional/functional_requirements.yaml) (Gestão administrativa)<br>**RN:** [RN009](file:///var/www/html/agsonhos/docs/requirements/business_rules/business_rules.yaml) (Política de devolução), [RN010](file:///var/www/html/agsonhos/docs/requirements/business_rules/business_rules.yaml) (Critérios de troca), [RN011](file:///var/www/html/agsonhos/docs/requirements/business_rules/business_rules.yaml) (Arrependimento 7 dias CDC), [RN012](file:///var/www/html/agsonhos/docs/requirements/business_rules/business_rules.yaml) (Documentação fiscal)<br>**RNF:** [RNF006](file:///var/www/html/agsonhos/docs/requirements/non_functional/non_functional_requirements.yaml) (Lock otimista em triagem de RMA) |
